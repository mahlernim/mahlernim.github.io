...
def validate_generated(value, min_words=120):
    ...
    disclosure_patterns = [
        ...
        r"\bthis (?:article|post) (?:was|is) (?:ai[- ]generated|generated by ai)\b",
        r"\btranslated (?:by|with) ai\b",
    ]
    if "<script" in lowered or "<iframe" in lowered or any(re.search(pattern, lowered) for pattern in disclosure_patterns):
