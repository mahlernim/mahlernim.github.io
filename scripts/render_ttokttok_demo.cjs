...
async function main(){
 ...
 try {
  ...
  await page.setContent(`<body style="margin:0;background:#164c40;color:#faf9f3;font-family:'Malgun Gothic',sans-serif"><div style="padding:65px 80px"><p style="font-size:24px;color:#c5d7b1">똑똑 자가검침 AI</p><h1 style="font-size:78px;line-height:1.3;letter-spacing:-4px;margin:30px 0">매달 자가검침,<br>이제 자동으로.</h1><p style="font-size:25px;color:#d1dfd5">평소에 확인하고, 검침 기간에 자동 제출.</p><p style="font-size:18px;color:#bdcfbb">Android 무료 테스트 · 공급사별 지원 범위 확인 · ahn-lab.org/ttokttok/</p></div></body>`);
